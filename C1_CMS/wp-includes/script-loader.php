...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->default_dirs = array('/admin/js/', '/wp-includes/js/');
	...
	$scripts->add( 'wp-theme-plugin-editor', "/admin/js/theme-plugin-editor$suffix.js", array( 'wp-util', 'wp-sanitize', 'jquery', 'jquery-ui-core', 'wp-a11y', 'underscore' ) );
	...
	if ( is_admin() ) {
		...
		$scripts->add( 'dashboard', "/admin/js/dashboard$suffix.js", array( 'jquery', 'admin-comments', 'postbox', 'wp-util', 'wp-a11y' ), false, 1 );
...
function wp_default_styles( &$styles ) {
	...
	$styles->default_dirs = array('/admin/', '/wp-includes/css/');
